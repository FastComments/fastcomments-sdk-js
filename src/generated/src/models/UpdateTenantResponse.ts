...
export function UpdateTenantResponseToJSON(json: any): UpdateTenantResponse {
    return UpdateTenantResponseToJSONTyped(json, false);
}

export function UpdateTenantResponseToJSONTyped(value?: UpdateTenantResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
