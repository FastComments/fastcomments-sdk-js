 ...
 */
export function instanceOfUnBlockUserFromCommentResponse(value: object): value is UnBlockUserFromCommentResponse {
...
export function UnBlockUserFromCommentResponseFromJSON(json: any): UnBlockUserFromCommentResponse {
    return UnBlockUserFromCommentResponseFromJSONTyped(json, false);
}

export function UnBlockUserFromCommentResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnBlockUserFromCommentResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UnBlockUserFromCommentResponseToJSON(json: any): UnBlockUserFromCommentResponse {
    return UnBlockUserFromCommentResponseToJSONTyped(json, false);
}

export function UnBlockUserFromCommentResponseToJSONTyped(value?: UnBlockUserFromCommentResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
