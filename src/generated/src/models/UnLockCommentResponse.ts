 ...
 * 
 * @export
 * @interface UnLockCommentResponse
 */
export interface UnLockCommentResponse {
    /**
     * 
     * @type {APIStatus}
     * @memberof UnLockCommentResponse
     */
    status: APIStatus;
    /**
     * 
...
/**
 * Check if a given object implements the UnLockCommentResponse interface.
 */
export function instanceOfUnLockCommentResponse(value: object): value is UnLockCommentResponse {
...
export function UnLockCommentResponseFromJSON(json: any): UnLockCommentResponse {
    return UnLockCommentResponseFromJSONTyped(json, false);
}

export function UnLockCommentResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UnLockCommentResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UnLockCommentResponseToJSON(json: any): UnLockCommentResponse {
    return UnLockCommentResponseToJSONTyped(json, false);
}

export function UnLockCommentResponseToJSONTyped(value?: UnLockCommentResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
