...
/**
 * Check if a given object implements the SendInviteResponse interface.
 */
export function instanceOfSendInviteResponse(value: object): value is SendInviteResponse {
...
export function SendInviteResponseFromJSON(json: any): SendInviteResponse {
    return SendInviteResponseFromJSONTyped(json, false);
}

export function SendInviteResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendInviteResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SendInviteResponseToJSON(json: any): SendInviteResponse {
    return SendInviteResponseToJSONTyped(json, false);
}

export function SendInviteResponseToJSONTyped(value?: SendInviteResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
