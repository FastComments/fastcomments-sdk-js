 ...
 */
export function instanceOfUpdateNotificationResponse(value: object): value is UpdateNotificationResponse {
...
export function UpdateNotificationResponseFromJSON(json: any): UpdateNotificationResponse {
    return UpdateNotificationResponseFromJSONTyped(json, false);
}

export function UpdateNotificationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateNotificationResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateNotificationResponseToJSON(json: any): UpdateNotificationResponse {
    return UpdateNotificationResponseToJSONTyped(json, false);
}

export function UpdateNotificationResponseToJSONTyped(value?: UpdateNotificationResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
