 ...
 */
export function instanceOfUpdateTenantUserResponse(value: object): value is UpdateTenantUserResponse {
...
export function UpdateTenantUserResponseFromJSON(json: any): UpdateTenantUserResponse {
    return UpdateTenantUserResponseFromJSONTyped(json, false);
}

export function UpdateTenantUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateTenantUserResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateTenantUserResponseToJSON(json: any): UpdateTenantUserResponse {
    return UpdateTenantUserResponseToJSONTyped(json, false);
}

export function UpdateTenantUserResponseToJSONTyped(value?: UpdateTenantUserResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
