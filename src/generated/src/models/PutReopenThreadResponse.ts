 ...
 * 
 * @export
 * @interface PutReopenThreadResponse
 */
export interface PutReopenThreadResponse {
    /**
     * 
     * @type {APIStatus}
     * @memberof PutReopenThreadResponse
     */
    status: APIStatus;
    /**
     * 
...
/**
 * Check if a given object implements the PutReopenThreadResponse interface.
 */
export function instanceOfPutReopenThreadResponse(value: object): value is PutReopenThreadResponse {
...
export function PutReopenThreadResponseFromJSON(json: any): PutReopenThreadResponse {
    return PutReopenThreadResponseFromJSONTyped(json, false);
}

export function PutReopenThreadResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutReopenThreadResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PutReopenThreadResponseToJSON(json: any): PutReopenThreadResponse {
    return PutReopenThreadResponseToJSONTyped(json, false);
}

export function PutReopenThreadResponseToJSONTyped(value?: PutReopenThreadResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
