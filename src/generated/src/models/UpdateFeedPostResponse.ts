 ...
 * 
 * @export
 * @interface UpdateFeedPostResponse
 */
export interface UpdateFeedPostResponse {
    /**
     * 
     * @type {APIStatus}
     * @memberof UpdateFeedPostResponse
     */
    status: APIStatus;
    /**
     * 
...
/**
 * Check if a given object implements the UpdateFeedPostResponse interface.
 */
export function instanceOfUpdateFeedPostResponse(value: object): value is UpdateFeedPostResponse {
...
export function UpdateFeedPostResponseFromJSON(json: any): UpdateFeedPostResponse {
    return UpdateFeedPostResponseFromJSONTyped(json, false);
}

export function UpdateFeedPostResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateFeedPostResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateFeedPostResponseToJSON(json: any): UpdateFeedPostResponse {
    return UpdateFeedPostResponseToJSONTyped(json, false);
}

export function UpdateFeedPostResponseToJSONTyped(value?: UpdateFeedPostResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
