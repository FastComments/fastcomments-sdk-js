 ...
 * 
 * @export
 * @interface PostFlagCommentResponse
 */
export interface PostFlagCommentResponse {
    /**
     * 
     * @type {APIStatus}
     * @memberof PostFlagCommentResponse
     */
    status: APIStatus;
    /**
     * 
...
/**
 * Check if a given object implements the PostFlagCommentResponse interface.
 */
export function instanceOfPostFlagCommentResponse(value: object): value is PostFlagCommentResponse {
...
export function PostFlagCommentResponseFromJSON(json: any): PostFlagCommentResponse {
    return PostFlagCommentResponseFromJSONTyped(json, false);
}

export function PostFlagCommentResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostFlagCommentResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function PostFlagCommentResponseToJSON(json: any): PostFlagCommentResponse {
    return PostFlagCommentResponseToJSONTyped(json, false);
}

export function PostFlagCommentResponseToJSONTyped(value?: PostFlagCommentResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
