 ...
 * 
 * @export
 * @interface DeleteHashTagResponse
 */
export interface DeleteHashTagResponse {
    /**
     * 
     * @type {APIStatus}
     * @memberof DeleteHashTagResponse
     */
    status: APIStatus;
    /**
     * 
...
/**
 * Check if a given object implements the DeleteHashTagResponse interface.
 */
export function instanceOfDeleteHashTagResponse(value: object): value is DeleteHashTagResponse {
...
export function DeleteHashTagResponseFromJSON(json: any): DeleteHashTagResponse {
    return DeleteHashTagResponseFromJSONTyped(json, false);
}

export function DeleteHashTagResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteHashTagResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteHashTagResponseToJSON(json: any): DeleteHashTagResponse {
    return DeleteHashTagResponseToJSONTyped(json, false);
}

export function DeleteHashTagResponseToJSONTyped(value?: DeleteHashTagResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
