 ...
 */
export function instanceOfGetCommentsPublicResponse(value: object): value is GetCommentsPublicResponse {
...
export function GetCommentsPublicResponseFromJSON(json: any): GetCommentsPublicResponse {
    return GetCommentsPublicResponseFromJSONTyped(json, false);
}

export function GetCommentsPublicResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCommentsPublicResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function GetCommentsPublicResponseToJSON(json: any): GetCommentsPublicResponse {
    return GetCommentsPublicResponseToJSONTyped(json, false);
}

export function GetCommentsPublicResponseToJSONTyped(value?: GetCommentsPublicResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
