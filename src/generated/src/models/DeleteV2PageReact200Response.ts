 ...
 * 
 * @export
 * @interface DeleteV2PageReact200Response
 */
export interface DeleteV2PageReact200Response {
    /**
     * 
     * @type {string}
     * @memberof DeleteV2PageReact200Response
     */
    code: string;
    /**
     * 
...
/**
 * Check if a given object implements the DeleteV2PageReact200Response interface.
 */
export function instanceOfDeleteV2PageReact200Response(value: object): value is DeleteV2PageReact200Response {
...
export function DeleteV2PageReact200ResponseFromJSON(json: any): DeleteV2PageReact200Response {
    return DeleteV2PageReact200ResponseFromJSONTyped(json, false);
}

export function DeleteV2PageReact200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteV2PageReact200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteV2PageReact200ResponseToJSON(json: any): DeleteV2PageReact200Response {
    return DeleteV2PageReact200ResponseToJSONTyped(json, false);
}

export function DeleteV2PageReact200ResponseToJSONTyped(value?: DeleteV2PageReact200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
