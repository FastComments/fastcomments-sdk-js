# GetV2PageReacts_200_response
## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **reactedIds** | **List** |  | [optional] [default to null] |
| **counts** | **Map** | Construct a type with a set of properties K of type T | [optional] [default to null] |
