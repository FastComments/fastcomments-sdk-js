...
| **createdFromIpHashed** | **String** |  | [default to null] |
| **verified** | **Boolean** |  | [default to null] |
| **loginId** | **String** |  | [default to null] |
| **loginIdDate** | **Long** |  | [default to null] |
| **loginCount** | **Integer** |  | [optional] [default to null] |
| **optedInNotifications** | **Boolean** |  | [optional] [default to null] |
| **optedInTenantNotifications** | **Boolean** |  | [optional] [default to null] |
| **hideAccountCode** | **Boolean** |  | [optional] [default to null] |
| **avatarSrc** | **String** |  | [optional] [default to null] |
| **isFastCommentsHelpRequestAdmin** | **Boolean** |  | [optional] [default to null] |
| **isHelpRequestAdmin** | **Boolean** |  | [optional] [default to null] |
| **isAccountOwner** | **Boolean** |  | [optional] [default to null] |
| **isAdminAdmin** | **Boolean** |  | [optional] [default to null] |
| **isBillingAdmin** | **Boolean** |  | [optional] [default to null] |
| **isAnalyticsAdmin** | **Boolean** |  | [optional] [default to null] |
| **isCustomizationAdmin** | **Boolean** |  | [optional] [default to null] |
...
| **profileCommentApprovalMode** | **Double** |  | [optional] [default to null] |
| **karma** | **Double** |  | [optional] [default to null] |
| **passwordHash** | **String** |  | [optional] [default to null] |
| **averageTicketAckTimeMS** | **Double** |  | [optional] [default to null] |
| **hasBlockedUsers** | **Boolean** |  | [optional] [default to null] |
| **bio** | **String** |  | [optional] [default to null] |
| **headerBackgroundSrc** | **String** |  | [optional] [default to null] |
