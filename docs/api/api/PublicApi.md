...
# **createV1PageReact**
> CreateV1PageReact createV1PageReact(tenantId, urlId, title, sso)
...
# **createV2PageReact**
> CreateV1PageReact createV2PageReact(tenantId, urlId, id, title, sso)
...
# **deleteV1PageReact**
> CreateV1PageReact deleteV1PageReact(tenantId, urlId, sso)
...
# **deleteV2PageReact**
> CreateV1PageReact deleteV2PageReact(tenantId, urlId, id, sso)
...
# **getV1PageLikes**
> GetV1PageLikes getV1PageLikes(tenantId, urlId, sso)
...
# **getV2PageReactUsers**
> GetV2PageReactUsersResponse getV2PageReactUsers(tenantId, urlId, id, sso)
...
# **getV2PageReacts**
> GetV2PageReacts getV2PageReacts(tenantId, urlId, sso)
